...
Jiyang Xu and not seriously updated ever since --- rely upon them at
your own risk!  Section~\ref{sec:tabling} was written by Terry Swift.
Sections~\ref{sec:leader} and \ref{sec:fixpoint} were written by David S. Warren.
The remaining sections were written more or less by all authors of
this technical manual.

Fuller credits can be found in the {\it The XSB Programmer's Manual}.
\newpage
...
for thread-private.  Bit x10 is 1 if Bit x20 has been explicitly set
...
\input{leader_determination}
\input{sched_fixpoint}
\end{document}
