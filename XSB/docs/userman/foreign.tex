...
\begin{description}
\ourCitem{void xsb\_domain\_error(CTXTdeclc char *valid\_domain,Cell culprit,char *pred,int arity,int arg)}{xsb\_domain\_error}
%
...
\ourCitem{void xsb\_existence\_error(CTXTdeclc char *objType,Cell culprit,char *pred,int arity,int arg)}{xsb\_existence\_error}
%
...
\ourCitem{void xsb\_permission\_error(CTXTdeclc char *op,char *obj,Cell culprit,char *pred,int arity)}{xsb\_permission\_error}
%
...
%----------------
\ourCitem{void xsb\_type\_error(CTXTdeclc char *valid\_type,Cell culprit,char *pred,int arity,int arg) }{xsb\_type\_error}
%
